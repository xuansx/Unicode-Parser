#pragma once
#ifndef ZoneAllocator_H_
#define ZoneAllocator_H_
...
//#endif
	explicit ZoneAllocator(ZoneMemory* zone) throw() : zone_(zone) {}
...
//#endif
	explicit RecyclingZoneAllocator(ZoneMemory* zone) throw()
